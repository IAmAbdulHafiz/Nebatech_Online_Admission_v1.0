...
<body>
    ...
    <div class="content">
        ...
        <div class="progress mb-4">
            <div class="progress-bar" role="progressbar" style="width: 40%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">Step 4 of 9</div>
        </div>

        <form action="education.php" method="POST" enctype="multipart/form-data">
            <!-- Wizard Step 2: Educational Background -->
